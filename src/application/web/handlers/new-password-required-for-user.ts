...
import NewPasswordRequiredForUser from '../../usecase/new-password-required-for-user';
...
export const handler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  ...
  try {
    ...
    return sendHttpOkResponse(await new NewPasswordRequiredForUser(authGateway).execute(event.body));
  } catch (err: any) {
