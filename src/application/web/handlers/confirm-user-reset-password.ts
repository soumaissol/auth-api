...
import ConfirmUserResetPassword from '../../usecase/confirm-user-reset-password';
...
export const handler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  ...
  try {
    ...
    return sendHttpOkResponse(await new ConfirmUserResetPassword(authGateway).execute(event.body));
  } catch (err: any) {
